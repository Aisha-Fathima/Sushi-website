![Screenshot 1](public/website_screenshot1.png) 
  <div align="center">
  ...
  <h2 align="center">Sushi Website</h2>
...
👉 **CSS Variables**: Leverage CSS variables for consistent styling across the project, allowing for easy updates and adjustments.

👉 **Importing CSS Files**: Promote modularity by importing CSS files into each other, ensuring organized and scalable styles.

👉 **Flex and Positioning**: Utilize flexbox and positioning properties in CSS to create responsive, well-structured layouts.

👉 **Rendering HTML through JavaScript**: Implement reusable JavaScript functions to dynamically render HTML, boosting code efficiency(dynamic HTML rendering).

👉 **Seamless Animations**: Enhance user experience with smooth and subtle animations, emphasizing fluid transitions.

👉 **BEM Method**: Follow the Block Element Modifier (BEM) methodology for naming classes, promoting a clear and maintainable structure.

👉 **Structured Project Organization**: Maintain an organized file and folder structure for easy project management and asset navigation.

👉 **Responsive Design**: Ensure the application is fully responsive across all devices by using media queries and fluid layout techniques.
...
```bash
  git clone https://github.com/Aisha-Fathima/sushi-website
  cd sushi-website
  ...
  <header>
    <nav class="header__nav">
      <div class="header__logo">
        ...
        <h4 data-aos="fade-down">Sakura Sushi</h4>
